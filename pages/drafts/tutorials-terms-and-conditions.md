...
2. The Organizer will appoint an awards committee (hereinafter the "Commission") that might include, i.a., Advisory Board members (<https://conference.mlinpl.org/2026/#advisory-board>), Invited Speakers (<https://conference.mlinpl.org/2026/#invited-speakers>), Student Research Workshop and Organizer representants (<https://conference.mlinpl.org/2026/#organizers>).
...
2. The registration for the Competition takes place via the registration form in the [Call for Tutorials](https://conference.mlinpl.org/2026/tutorials) (hereinafter, the “Website”).
